    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form role="form" action="{{url('client/company-available-rating/'.Request('companyAvailableRating')->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input required type="text" class="form-control" name="name" id="name" value="{{$companyAvailableRating->name}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="name_ar">@lang('company_available_rating.name_ar')</label>
                                    <input required type="text" class="form-control" name="name_ar" id="name_ar" value="{{$companyAvailableRating->name_ar}}">
                                </div>
                            </div>
                        </div>
                    </div>
