            ...
            <table id="example2" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="background-color: #1fbdd9 !important;">@lang('employee_rating.client')</th>
                        <th style="background-color: #1fbdd9 !important;">@lang('employee_rating.company')</th>
                    ...
                    @if (!empty($employee_ratings))
                        @foreach ($employee_ratings as $key => $employee_rating)
                            <tr>
                                ...
                                <td> {{ $employee_rating->availableRating ? $employee_rating->availableRating->name : '' }}
                                </td>
                                <td>
