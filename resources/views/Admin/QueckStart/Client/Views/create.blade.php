    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form role="form" action="{{url('admin/quick-start-create-client')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="@lang('client.name')" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="email">@lang('client.email')</label>
                                    <input type="email" class="form-control" name="email" id="email" placeholder="@lang('client.email')" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="phone" id="phone" placeholder="@lang('client.phone')" required>
                                </div>

                                <div class="col-md-6">
                                    <label for="password">@lang('client.password')</label>
                                    <input type="password" class="form-control" name="password" id="password" placeholder="@lang('client.password')" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="available_companies_count" id="available_companies_count" value="0" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="available_employees_count">@lang('client.available_employees_count')</label>
                                    <input type="number" class="form-control" name="available_employees_count" id="available_employees_count" value="0" required>
                                </div>
                            </div>
                        </div>
                    </div>
