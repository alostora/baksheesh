                        ...
                        <div class="col-sm-4 col-md-2">
                            <div class="color-palette-set">
                                <div class="bg-red disabled color-palette">
                                    <span>
                                        @lang('governorate.inactive') : {{$governorates ? $governorates->where('stopped_at','!=',null)->count() : 0}}
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-2">
                            <div class="color-palette-set">
                                <div class="bg-green disabled color-palette">
                                    <span>
                                        @lang('governorate.active') : {{$governorates ? $governorates->where('stopped_at',null)->count() : 0}}
                                    </span>
                                </div>
                            </div>
                        </div>
