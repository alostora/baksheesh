    ...
    $(function() {
        ...
        var areaChartData = {
            ...
            datasets: [{
                ...
                {
                    label: 'ddddddddddd',
                    fillColor: 'rgba(60,141,234,0.9)',
                    strokeColor: 'rgba(60,141,234,0.8)',
                    pointColor: '#3b8bba',
                    pointStrokeColor: 'rgba(60,141,234,1)',
                    pointHighlightFill: '#fff',
                    pointHighlightStroke: 'rgba(60,141,234,1)',
                    data: [28, 48, 44, 33, 86, 12, 70]
                },
            ]
        }
