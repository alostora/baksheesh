    @include('Guest.EmployeePayment.Parts.cardInfo')
    @include('Guest.EmployeePayment.Parts.rating')
    @include('Guest.EmployeePayment.Parts.comment')
    @include('Guest.EmployeePayment.Parts.payment')
