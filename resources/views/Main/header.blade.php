...
<link rel="stylesheet" href="{{url('AdminDesign')}}/bootstrap-print.css" media="print">
    ...
    <style>
        ...
        * {
            -webkit-print-image-adjust: exact !important;
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{ url('/') }}/user2-160x160.png" class="user-image" alt="User Image"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header" style="background-color: #fff;">
                                    <img src="{{ url('/') }}/user2-160x160.png" class="img-circle"
                                        alt="User Image" style="border-radius: 50%;">

                                    <p>
                                        {{ auth()->user()->name }}
                                        <small>Member since
                                            {{ date('Y-m-d', strtotime(auth()->user()->created_at)) }}</small>
                                    </p>
                                </li>
                                ...
                                <li class="user-footer">
                                    @if (auth()->user()->accountType == \App\Foundations\LookupType\AccountTypeCollection::client())
                                        <div class="pull-left">
                                            <a href="{{ url('client/client-profile') }}"
                                                class="btn btn-default btn-flat">@lang('dashboard.profile')</a>
                                        </div>
                                    @endif
                                    <div class="pull-right">
                                        <a href="{{ url('admin/logout') }}"
                                            class="btn btn-default btn-flat">@lang('dashboard.logout')</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
