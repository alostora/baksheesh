...
Route::group([
    ...
    Route::get('company/client-employee-available-rating/{user}', [CompanyEmployeeController::class, 'clientEmployeeAvailableRatings']);

    Route::get('company/client-companies/{user}', [CompanyEmployeeController::class, 'clientCompanies']);
