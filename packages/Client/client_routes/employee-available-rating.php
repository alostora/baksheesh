...
use Client\Http\Controllers\Views\EmployeeAvailableRatingController;
...
Route::group([
    ...
    Route::get('employee-available-rating/create', [EmployeeAvailableRatingController::class, 'create']);
